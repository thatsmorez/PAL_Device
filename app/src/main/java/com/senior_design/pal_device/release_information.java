...
public class release_information extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ArrayAdapter<String>(release_information.this, android.R.layout.simple_list_item_1, itemList);
        ...
        select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(selectedPatient != null) {
                    Intent intent = new Intent(release_information.this, confirm_release.class);
                    ...
                    AlertDialog.Builder dlgAlert  = new AlertDialog.Builder(release_information.this);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(release_information.this, music_therapist_home.class);
                Bundle bundle = new Bundle();
                bundle.putString("user", accountUser);
                intent.putExtras(bundle);
                startActivity(intent);
        ...
        ChildEventListener childEventListener = myRef.child("Patient").addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String prevChildKey) {
                ...
                if(musicTherapist.equals(accountUser)){
